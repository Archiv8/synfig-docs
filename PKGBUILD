...
pkgrel=1
# epoch=
pkgdesc="Open-source 2D Animation Software. Core package providing a CLI."
arch=("x86_64")
url="https://www.synfig.org/"
license=("GPL2")
# groups=()
depends=("boost-libs" "cairo" "fftw" "fontconfig" "freetype2" "glibmm" "libsigc++" "libxml++2.6" "mlt" "pango" "synfig-etl")
# optdepends=()
makedepends=("boost" "cmake" "git" "intltool")
# checkdepends=()
# provides=()
conflicts=("synfig")
replaces=("synfig")
